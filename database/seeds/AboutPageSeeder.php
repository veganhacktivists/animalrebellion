    ...
    public function run()
    {
        $culturePage = \App\Models\AboutPage::create([
            ...
            'content' => 'We aim to build a culture that is inclusive, regenerative and always evolving.'.
                ...
                '\n\nWe are constantly learning and striving to build a culture that eradicates manifestations of these systems '.
                ...
                '\n\nWe seek to build a culture based on principles from nature and ecology. Its purpose is to nurture a new culture that '.
